...
func (p *ModelAssetProvider) GetSchema() crud.Schema {
	return crud.Schema{
		...
		Fields: []crud.Field{
			...
			{Name: "model_url", Type: "file", Label: "GLB File", Required: true, Accept: "model/gltf-binary"},
			{Name: "canvas_mesh_name", Type: "string", Label: "Canvas Mesh", CreateHidden: true},
			{Name: "default_scale", Type: "number", Label: "Default Scale", CreateHidden: true},
