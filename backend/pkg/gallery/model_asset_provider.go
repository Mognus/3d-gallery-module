...
func (p *ModelAssetProvider) GetSchema() crud.Schema {
	return crud.Schema{
		...
		Fields: []crud.Field{
			...
			{Name: "model_url", Type: "string", Label: "Model URL", Required: true, Width: "300px"},
			{Name: "canvas_mesh_name", Type: "string", Label: "Canvas Mesh", Width: "160px"},
			{Name: "default_scale", Type: "number", Label: "Default Scale", Width: "120px"},
