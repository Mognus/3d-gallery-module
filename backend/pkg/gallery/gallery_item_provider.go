...
func (p *GalleryItemProvider) GetSchema() crud.Schema {
	...
	return crud.Schema{
		...
		Fields: []crud.Field{
			...
			{Name: "title", Type: "string", Label: "Title", Required: true, Width: "200px"},
			{Name: "model_asset_id", Type: "relation", Label: "Model Asset", Required: true, TableHidden: true, Options: assetOptions},
			{Name: "model_asset", Type: "object", Label: "Model Asset", Readonly: true, Width: "160px"},
			{Name: "image_id", Type: "relation", Label: "Image", TableHidden: true, Options: imageOptions},
			{Name: "image", Type: "object", Label: "Image", Readonly: true, Width: "160px"},
